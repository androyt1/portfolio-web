    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(ellipse, rgba(232,75,26,.07) 0%, transparent 65%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{
         ...
         */}
        <div id="hero-heading" style={{ marginTop: 24 }} aria-label="Crafting Digital Futures">
        ...
        <motion.p
          ...
          style={{
            ...
            color: 'var(--dim)',
            lineHeight: 1.65, marginTop: 24, maxWidth: 360,
          }}
        >
          Senior Frontend Engineer{' '}
          <span style={{ color: '#E84B1A' }}>→</span>{' '}
        ...
        <motion.div
          {...fadeUp(0.88)}
          style={{ marginTop: 36, display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'center' }}
        >
          <MagneticButton
        ...
        <motion.div
          {...fadeUp(1.0)}
          aria-hidden="true"
          style={{ marginTop: 48, display: 'flex', alignItems: 'center', gap: 10, color: 'var(--dim)' }}
        >
          <div style={{
            width: 1, height: 44,
            background: 'linear-gradient(to bottom, transparent, rgba(238,235,228,.28))',
            animation: 'float 2.2s ease-in-out infinite',
          }} />
          <span style={{
            fontFamily: "'JetBrains Mono', monospace", fontSize: 9,
            letterSpacing: '.22em', textTransform: 'uppercase', writingMode: 'vertical-rl',
          }}>
            scroll
          </span>
        </motion.div>
      ...
      <div
        aria-hidden="true"
        style={{ width: '100%', height: 'clamp(340px, 55vw, 680px)', position: 'relative', zIndex: 1 }}
      >
