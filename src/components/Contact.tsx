  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="rv">
          <span className="slbl">Let's Connect</span>
        </div>
        ...
        >
          Whether it's an AI engineering role, a frontend contract, or a wild
          idea for the Nigerian market — let's talk.
        </p>

        <div className="rv d3" style={{ marginTop: 44 }}>
          <MagneticButton
            className="clink"
            onClick={() => mailto("androyt1@gmail.com")}
        ...
        >
          <MagneticButton
            className="ibtn"
            onClick={() => openLink("https://github.com/androyt1")}
          ...
          <MagneticButton
            className="ibtn"
            onClick={() =>
              openLink("https://linkedin.com/in/andrew-aghoghovwia")
            }
